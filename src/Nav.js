  ...
  return (
    <div className="nav-body-div" id="navbar">
        ...
        <div className="nav-menu-div">
          ...
          <Link to="/Projects" className="nav-resume-link" ><li className="menu-item">All Projects</li></Link>
            ...
            <li className="menu-item"> <a className="nav-linkedin" id="menu-link" target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/erik-russell-software-engineer/">Linkedin</a></li>
